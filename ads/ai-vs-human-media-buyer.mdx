...
Josh Goldsmith, Nest's Head of Social with fifteen years in Facebook advertising, frames it plainly: "Who's doing bidding these days? Automatic bidding's come in and that's the norm now." The question isn't which bid strategy to pick. It's whether your creative supply can feed the algorithm fast enough.
...
One in-house media buyer costs $66K to $**97K/year** according to Indeed and Glassdoor data. A freelance media buyer runs $1,500 to $**5,000/month** per Ryze's 2026 benchmarks. An agentic marketing platform like **Ares** costs around **\$300/month** for execution automation across Meta, Google, and TikTok.
...
| --- | --- | --- |
| Agentic platform like **Ares** \+ fractional consultant | Agent handles execution, consultant sets strategy quarterly |
| Agentic platform \+ existing buyer | Buyer redirects time to creative direction and offer testing |
...
<AccordionGroup>
  ...
  <Accordion title="How much ad spend do I need before an AI agent makes sense for my roofing company?">
    AI agents deliver ROI starting around \*\*$10K/month in ad spend**. Below that threshold, manual management is simpler. Above $50K/month, an agent becomes essential - human buyers cannot execute enough creative tests to stay competitive. Between $10K and $50K is the sweet spot where agents start compounding advantages without requiring enterprise-scale budgets.
  </Accordion>
